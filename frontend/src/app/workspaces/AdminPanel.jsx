    ...
    <div className="space-y-4">
      ...
      <section className="rounded border border-outline-variant bg-surface-lowest p-4 shadow-sm">
        ...
        <form onSubmit={submitCreate} className="grid gap-2 md:grid-cols-3">
          ...
          <input placeholder="Sous-direction (1 ou 2)" className="rounded border border-outline-variant p-2 text-sm" value={form.sub_directorate_id} onChange={(e) => setForm((s) => ({ ...s, sub_directorate_id: e.target.value }))} />
          <input placeholder="Service" className="rounded border border-outline-variant p-2 text-sm" value={form.service_label} onChange={(e) => setForm((s) => ({ ...s, service_label: e.target.value }))} />
            ...
            <tbody>
              {users.map((user) => (
                <tr key={user.id} className="border-t border-outline-variant">
                  ...
                  <td className="p-2">{user.role_code}</td>
